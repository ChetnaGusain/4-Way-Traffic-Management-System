...
void loop()
{
  ...
  delay(7000);
  digitalWrite(Lane3[2], LOW); // Changed from Lane3[2] to Lane1[0]
  digitalWrite(Lane4[0], LOW); // Added this line to turn off Lane4[0]
  digitalWrite(Lane3[1], HIGH);
  ...
  delay(7000);
  digitalWrite(Lane1[0], LOW); // Changed from Lane2[1] to Lane1[1]
